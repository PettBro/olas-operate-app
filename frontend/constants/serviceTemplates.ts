...
const AGENTS_FUN_COMMON_TEMPLATE: Pick<ServiceTemplate, "env_variables" | "hash" | "image" | "description" | "service_version" | "agent_release"> = {
...
const BABYDEGEN_COMMON_TEMPLATE: Pick<ServiceTemplate, "hash" | "service_version" | "agent_release"> = {
		...
		[MiddlewareChainMap.OPTIMISM]: {
			...
			fund_requirements: {
				...
				[OPTIMISM_TOKEN_CONFIG[TokenSymbol.USDC]?.address as string]: {
					agent: 0,
					safe: +parseUnits(16, OPTIMISM_TOKEN_CONFIG[TokenSymbol.USDC]?.decimals),
				},
			},
		},
	},
...
export const SERVICE_TEMPLATES: ServiceTemplate[] = [PREDICT_SERVICE_TEMPLATE, AGENTS_FUN_BASE_TEMPLATE, MODIUS_SERVICE_TEMPLATE, OPTIMUS_SERVICE_TEMPLATE, PETT_AI_SERVICE_TEMPLATE] as const;

export const getServiceTemplates = (): ServiceTemplate[] => SERVICE_TEMPLATES;

export const getServiceTemplate = (templateHash: string): ServiceTemplate | undefined => SERVICE_TEMPLATES.find((template) => template.hash === templateHash);
